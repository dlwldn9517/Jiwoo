...
public class Main {
	...
	public static void m1() {
		...
		// 세트 확인
		System.out.println(set);	// index가 없어서 저장한 순서랑 다르다.
...
//		System.out.println(set1);
		...
		// 부분집합 여부 판단
		boolean result1 = set1.contains(set3);	// set3가 set1의 부분집합이면 true
		boolean result2 = set2.contains(set3);	// set3가 set2의 부분집합이면 true
