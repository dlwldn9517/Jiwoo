...
public class Ex01_array1 {
	...
	public static void main(String[] args) {
		...
		// 2. 2차원 배열의 생성
		//  1) arr = new int[3][2];	_ 3행 2열의 구조 (김밥3줄, 각 2개씩 조각)
		
		//  2) arr = new int[3][]; _ 3행 n열의 구조 (김밥3줄, 모두 다르게 조각) - 배열이 생성된게 아님
		//     arr[0] = new int[5];	_ 1번째 1차원 배열 (1번째 김밥은 5개 조각)
		//     arr[1] = new int[3];	_ 2번째 1차원 배열 (2번째 김밥은 3개 조각)
		//     arr[2] = new int[8];	_ 3번째 1차원 배열 (3번째 김밥은 8개 조각)
