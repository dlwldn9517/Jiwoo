...
public class Ex01_array1 {
	...
	public static void main(String[] args) {
		...
		// 배열 선언 및 생성
		// 1. 배열 선언
		//	  int[] arr;	_ 이 방식을 사용하는 게 좋다.
		//    int arr[];	_ c언어 호환때문에 이것도 지원
		// 2. 배열 생성
		//    arr = new int[3];
		// 3. 배열 선언 및 생성
		// 	  int[] arr = new int[3];
		...
		for(int i = 0; i < arr.length; i++) {
			...
			// 값을 넣지 않았는데 오류가 뜨지 않았다. 왜? 이미 값을 가지고 있다.
		}
		...
		double average = (double)total / arr.length;	// total이 int이기 때문에 double로 캐스팅함
